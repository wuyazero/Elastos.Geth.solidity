...
const std::map<std::string, Instruction> dev::solidity::c_instructions =
{
	...
	{ "EXTPAYLOADSIZE", Instruction::EXTPAYLOADSIZE },
	{ "EXTPAYLOADCOPY", Instruction::EXTPAYLOADCOPY },
...
{ //												Add, Args, Ret, SideEffects, GasPriceTier
	...
	{ Instruction::EXTPAYLOADSIZE,	{ "EXTPAYLOADSIZE",	0, 1, 1, false, Tier::ExtCode } },
	{ Instruction::EXTPAYLOADCOPY,	{ "EXTPAYLOADCOPY",	0, 4, 0, true, Tier::ExtCode } },
